...
export const AboutSection: React.FC<AboutSectionProps> = ({ onContactClick }) => {
  ...
  return (
    <section
      id="about"
      className="relative min-h-screen flex flex-col justify-center items-center px-5 sm:px-8 md:px-10 py-20 overflow-hidden bg-[#0C0C0C]"
    >
      {/* 4 Decorative 3D Floating Elements */}
      {/* Top-left: Moon icon */}
      ...
      <div className="relative z-20 flex flex-col items-center text-center max-w-4xl mx-auto w-full">
        ...
        {/* Spacing container between heading & text, then text & button */}
